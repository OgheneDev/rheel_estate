...
// Replace the existing WhatsApp SVG component with this one
const WhatsAppIcon = () => (
            ...
            <div className="content">
                ...
                <div className='border rounded-[15px] p-3 mb-5'>
                    <article className='mb-5'>
                        <p className='text-[18px] mb-2'>Buy now for just</p>
                        <h3 className='text-2xl font-bold'>₦{formatPrice(property.price)}</h3>
                    </article>
                    <div className='flex items-center justify-between mb-5'>
                        <button className='flex items-center gap-2 text-[#0A2F1E] border text-[13px] border-[#0A2F1E] rounded-[15px] px-4 py-2'>
                        ...
                        <a 
                            ...
                            className='flex items-center gap-2 text-[white] bg-[#0A2F1E] text-[13px]  rounded-[15px] px-4 py-2'
                        >
                            <WhatsAppIcon />
                            Make enquiries
                        </a>

...
const PropertyList = () => {
    ...
    return (
        <div>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:px-[50px] gap-10'>
            ...
            <div className="flex justify-center">
                <button 
                    ...
                    className='border-[#DB2626] border rounded-full cursor-pointer px-3 py-2 text-[14px] mt-10'
                >

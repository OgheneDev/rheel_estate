        ...
        <div className="max-w-4xl mx-auto bg-[#016A5280] rounded-xl p-6 hidden md:block">
          ...
          <div className="bg-white rounded-xl rounded-tl-none p-2 flex items-center">
            <div className="flex-grow flex items-center px-2">
              ...
              <select className="block py-3 text-gray-700 bg-white  border-gray-300 focus:outline-none appearance-none pr-8">
            ...
            <button className="bg-black hover:bg-gray-900 text-white font-medium py-3 px-8 rounded-xl ml-2">
              Search
            </button>
          </div>
        </div>
        ...
        <div className="md:hidden ]">
          ...
          <div className="flex mb-2 gap-2">
            ...
            <div className="flex-1 relative bg-white rounded-md">
              ...
              <select className="block w-full pl-8 pr-2 py-2 text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none appearance-none text-sm">
                <option value="">Property type</option>
                <option value="apartment">Apartment</option>
                <option value="house">House</option>
                <option value="villa">Villa</option>
          ...
          <div className="flex justify-end">
            <button className=" bg-black hover:bg-gray-900 text-white font-medium py-2 px-8 rounded-md">
              Search
            </button>
          </div>
        </div>
